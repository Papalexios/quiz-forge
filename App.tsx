          ...
          >
            <div className="text-center my-8">
              ...
              <p className="mt-4 max-w-3xl mx-auto text-lg sm:text-xl text-slate-600 dark:text-slate-400">
                Instantly embed expert-level quizzes that captivate your audience, reinforce learning with detailed explanations, and dramatically boost on-page engagement. Go from static text to a memorable <span className="font-bold text-slate-800 dark:text-slate-200">educational experience</span> in minutes.
              </p>
            </div>
